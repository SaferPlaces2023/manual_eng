# 🏚️ Damage Assessment Model - Safer\_DAMAGE
...
* Curva di Danno o Vulnerabilità (Damage Function) definita dall'utente mediante in tool [#strumento-curve-di-danno-e-valore-edifici](../saferplaces-gui-web/top-bar.md#strumento-curve-di-danno-e-valore-edifici "mention")
